package com.qvdz.myapp.zpmodule;
...
public class ZPModule extends ReactContextBaseJavaModule {
    ...
    public void payOrder(String zpTransToken) {
        ...
        ZaloPaySDK.getInstance().payOrder(currentActivity, zpTransToken, "petshop://app", listener);
    }

    // @ReactMethod
    // public void installApp() {
    // Activity currentActivity = getCurrentActivity();
    // ZaloPaySDK.getInstance().navigateToZaloOnStore(currentActivity);
    // }
